...
export default function AboutUsTop() {
  ...
  return (
    <div
      ref={ref}
      className={`${styles.aboutUsTop} ${styles.fadeInUp} ${
    ...
    >
      ...
      <div className={styles.aboutWrapper}>
        <div className={styles.aboutUsTopInfo}>
          ...
          <p>
            В Lá Vish Skin вярваме, че красотата започва с увереността. Нашето
            студио е създадено с мисъл за Вас – за да се чувствате не само
            красиви, но и специални. Предлагаме висококачествени лазерни
            процедури, съобразени с най-новите технологии и стандарти, за да
            осигурим ефективни и дълготрайни резултати.
          </p>
        </div>
        <div
